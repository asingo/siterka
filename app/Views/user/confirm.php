                ...
                <section class="login_content">
                    ...
                    <form method="post" action="doConfirm">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <p>Callsign Anda</p>
                            <input type="text" class="form-control" name="callsign" disabled value="<?= $anggota['callsign']; ?>" id="callsign" required="" />
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <p>Nama Anda</p>
                            <input type="text" class="form-control" name="name" disabled value="<?= $anggota['nama']; ?>" id="nama" required="" />
                        </div>
                        <div>
                            <p>Masa Berlaku IAR Anda</p>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <p>Konfirmasi Password Akun Anda</p>
                            <input type="password" class="form-control" name="pass" id="pass" placeholder="Masukkan Password Akun Anda" required="" />
                        </div>
                        <div>
